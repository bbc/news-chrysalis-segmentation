...
INSERT INTO vb_dates VALUES ('2022-01-15', '2022-01-17');
...
SELECT count(distinct audience_id) FROM vb_page_topics  LIMIT 10; --4,565,305
...
SELECT count(*) FROM vb_page_topics_perc    LIMIT 10;--19,557,138
